...
/* Input Ports  */
    sc_in<sc_int<32> > input[BUFFER_NUM]; //from 1 bank of Input SRAM
...
/* Registers  */
    ...
    sc_signal<sc_int<32> > output_regs[BUFFER_NUM];
    sc_signal<sc_uint<32> > ctrl_reg;


/* Shift Registers  */
    sc_signal<sc_int<32> > shift_regs[BUFFER_NUM][SH_REG_NUM];

/* Output Ports   */
    sc_out<sc_int<32> > output[BUFFER_NUM]; //9 buffer to store partial sum
